...
# ggmcmc
list(SOS=combined_param_sos_data, EOS=combined_param_eos_data, GreenUp=combined_param_gup_data) %>% 
...
summary_data$phe_type <- factor(summary_data$phe_type, levels = c("SOS", "GreenUp", "EOS"))
ggplot(summary_data, aes(x = Parameter, y = mean_value, color = phe_type)) +
  ...
  scale_color_manual(
    values = c("SOS" = "darkgreen", "GreenUp" = "darkolivegreen3", "EOS" = "chocolate4", "")
    #coral/chocolate
  ) +
  theme(
